...
Ext.define("Khusamov.svg.geometry.Polyline", {
	 ...
	 * Возвращает false при условии что полилиния задана по часовой стрелке и ось Оу смотрит вверх.
	 * Возвращает true при условии что полилиния задана против часовой стрелке и ось Оу смотрит вниз.
